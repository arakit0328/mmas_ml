...
void ObliviousLS(SCPinstance& instance,
                 const SCPsolution& CS,
                 SCPsolution& CSimp,
                 Rand& rnd)
{
  CSimp = CS;
  int c = CSimp.get_column_maxscore(instance, rnd);
  CSimp.remove_column(instance, c);
...
int main(int argc, char** argv)
{
  ...
  greedy_construction(pData, CS, rnd);
  CS.print_solution();
  ObliviousLS(pData, CS, CSimp, rnd);
